...
void mouse_callback(GLFWwindow* window, double xpos, double ypos) {
    ...
    float yoffset = lastY - ypos; // Inversé car les coordonnées écran vont de haut en bas
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "3D Cube with Camera", nullptr, nullptr);
    if (!window) {
